...
template <typename T1, typename T2> struct Pair {
  ...
  Pair(T1 &&_first, const T2 &_second)
      : first(std::move(_first)), second(_second) {}
  Pair(const T1 &_first, T2 &&_second)
      : first(_first), second(std::move(_second)) {}
};
...
namespace std {
template <typename T1, typename T2> struct hash<lstd::Pair<T1, T2>> {
